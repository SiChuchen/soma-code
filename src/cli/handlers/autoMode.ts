...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for somacode.\n' +
  '\n' +
  'somacode has an "auto mode" that uses an AI classifier to decide whether ' +
  ...
  if (!hasCustomRules) {
    process.stdout.write(
      'No custom auto mode rules found.\n\n' +
        ...
        `Run \`${CLI_COMMAND_NAME} auto-mode defaults\` to see the default rules for reference.\n`,
    )
    return
  }
