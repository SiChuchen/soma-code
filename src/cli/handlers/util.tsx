...
import { SomaLanding } from '../../components/LogoV2/SomaLanding.js';
...
export async function doctorHandler(root: Root): Promise<void> {
  ...
  const initialState: AppState = {
    ...defaultState,
    toolPermissionContext,
    agentDefinitions: await getAgentDefinitionsWithOverrides(cwd())
  };
  await new Promise<void>(resolve => {
    root.render(<AppStateProvider initialState={initialState} onChangeAppState={onChangeAppState}>
        <KeybindingSetup>
