...
function roughTokenCountEstimationForBlock(
  ...
  if (typedBlock.type === 'tool_result') {
    return roughTokenCountEstimationForContent(
      typedBlock.content as string | Array<unknown> | undefined,
    )
  }
  if (typedBlock.type === 'tool_use') {
    ...
    return roughTokenCountEstimation(
      (typeof typedBlock.name === 'string' ? typedBlock.name : '') +
        jsonStringify(typedBlock.input ?? {}),
    )
  }
  if (
  ...
  return roughTokenCountEstimation(jsonStringify(typedBlock))
}
