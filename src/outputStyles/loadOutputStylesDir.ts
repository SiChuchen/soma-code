...
/**
 * Loads markdown files from .soma/output-styles directories throughout the project
 * and from ~/.soma/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .soma/output-styles/*.md -> project styles
 * - User ~/.soma/output-styles/*.md -> user styles (overridden by project styles)
 *
