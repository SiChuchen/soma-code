...
export type Props = {
   ...
   * project-scoped (written to the assistant's .soma/settings.json via
   * install.ts) and should not leak to the user's global ~/.soma/settings.
   */
...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between available models. Applies to this session and future somacode sessions. For provider-specific or previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
