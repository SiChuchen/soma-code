...
export function CostThresholdDialog(t0) {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = <Box flexDirection="column"><Text>Monitor your spending in billing settings.</Text></Box>;
    $[0] = t1;
  } else {
    t1 = $[0];
  }
  ...
  let t4;
  if ($[4] !== onDone || $[5] !== t3) {
    t4 = <Dialog title="You've spent $5 on the somacode API this session." onCancel={onDone}>{t1}{t3}</Dialog>;
    $[4] = onDone;
    $[5] = t3;
    $[6] = t4;
  } else {
