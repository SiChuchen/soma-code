    ...
    case "attachment":
      {
        ...
        let t2;
        if ($[0] !== addMargin || $[1] !== isTranscriptMode || $[2] !== attachment || $[3] !== verbose) {
          t2 = <AttachmentMessage addMargin={addMargin} attachment={attachment} verbose={verbose} isTranscriptMode={isTranscriptMode} />;
          $[0] = addMargin;
          $[1] = isTranscriptMode;
          $[2] = attachment;
          $[3] = verbose;
