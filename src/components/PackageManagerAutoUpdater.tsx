...
import { getPackageManagerUpdateInstruction } from '../utils/distribution.js';
...
export function PackageManagerAutoUpdater(t0) {
  ...
  const updateInstruction = getPackageManagerUpdateInstruction(packageManager);
  let t4;
  if ($[3] !== verbose) {
  ...
  let t5;
  if ($[5] !== updateInstruction) {
    t5 = <Text color="warning" wrap="truncate">Update available! {updateInstruction}</Text>;
    $[5] = updateInstruction;
    $[6] = t5;
  } else {
    t5 = $[6];
