...
import { SomaLanding } from './LogoV2/SomaLanding.js';
  ...
  const securityStep = <Box flexDirection="column" gap={1} paddingLeft={1}>
      ...
      <Box flexDirection="column" width={70}>
         ...
         */}
          <OrderedList>
          <OrderedList.Item>
            <Text>somacode can make mistakes</Text>
            <Text dimColor wrap="wrap">
              You should always review somacode&apos;s responses, especially when
              <Newline />
              running code.
              <Newline />
            </Text>
          ...
          <OrderedList.Item>
            ...
            <Text dimColor wrap="wrap">
              Review the code and commands carefully before approving anything.
            </Text>
          </OrderedList.Item>
        </OrderedList>
      </Box>
      <Text dimColor wrap="wrap">
        Authentication and provider setup can be completed later from the main
        interface when you need them.
      </Text>
      <PressEnterToContinue />
    </Box>;
  // Create the steps array - determine which steps to include based on current auth state
  ...
  if (shouldOfferTerminalSetup()) {
    steps.push({
      ...
      component: <Box flexDirection="column" gap={1} paddingLeft={1}>
          <Text bold>Use somacode&apos;s terminal setup?</Text>
