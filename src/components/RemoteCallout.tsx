...
export function RemoteCallout({
  ...
  const options: OptionWithDescription<RemoteCalloutSelection>[] = [{
    ...
    description: 'Allow a secure remote connection to this session.',
    value: 'enable'
  }, {
    label: 'Not now',
  ...
  return <PermissionDialog title="Remote Control">
      <Box flexDirection="column" paddingX={2} paddingY={1}>
        <Box marginBottom={1} flexDirection="column">
          <Text>
            Remote Control lets you reopen this CLI session from another
            signed-in somacode client, so you can continue the same session
            elsewhere.
          </Text>
          <Text> </Text>
          <Text>
