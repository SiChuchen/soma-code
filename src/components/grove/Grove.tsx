...
type GroveDialogDecision = Exclude<GroveDecision, 'skip_rendering'>;
type GroveSelectValue = Exclude<GroveDialogDecision, 'escape'>;
type GroveOption = {
  label: string;
  value: GroveSelectValue;
};
type Props = {
...
function GracePeriodContentBody() {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box paddingLeft={1}><Text>{t2}{t3}<Text>— Allow the use of your chats and coding sessions to train and improve somacode AI models. Change anytime in Privacy Settings.</Text></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
...
function PostGracePeriodContentBody() {
  ...
  let t2;
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Box flexDirection="column"><Text bold={true}>Help improve somacode</Text><Text>Allow the use of your chats and coding sessions to train and improve somacode AI models. You can change this anytime in Privacy Settings.</Text></Box>;
    $[2] = t2;
  } else {
    t2 = $[2];
  }
...
export function GroveDialog(t0: Props): React.ReactNode {
  const $ = _c(34);
  const {
    showIfAlreadyViewed,
    location,
  ...
  if ($[5] !== groveConfig?.notice_is_grace_period || $[6] !== onDone) {
    t3 = async function onChange(value: GroveDialogDecision) {
      bb21: switch (value) {
        case "accept_opt_in":
          {
  ...
  if ($[8] !== groveConfig?.domain_excluded) {
    t4 = groveConfig?.domain_excluded ? [{
      label: "Accept terms \xB7 Help improve somacode: OFF (for emails with your domain)",
      value: "accept_opt_out"
    }] : [{
      label: "Accept terms \xB7 Help improve somacode: ON",
      value: "accept_opt_in"
    }, {
      label: "Accept terms \xB7 Help improve somacode: OFF",
      value: "accept_opt_out"
    }];
  ...
  const acceptOptions = t4 as GroveOption[];
  let t5;
...
export function PrivacySettingsDialog(t0) {
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text>Review and manage your privacy settings in Privacy Settings.</Text>;
    $[9] = t5;
  } else {
    t5 = $[9];
  }
  ...
  if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box width={44}><Text bold={true}>Help improve somacode</Text></Box>;
    $[10] = t6;
  } else {
    t6 = $[10];
  }
