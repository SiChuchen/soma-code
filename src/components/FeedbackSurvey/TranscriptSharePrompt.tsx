...
export function TranscriptSharePrompt(t0) {
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box><Text color="ansi:cyan">{BLACK_CIRCLE} </Text><Text bold={true}>Can the service provider look at your session transcript to help improve somacode?</Text></Box>;
    $[6] = t3;
  } else {
    t3 = $[6];
  }
