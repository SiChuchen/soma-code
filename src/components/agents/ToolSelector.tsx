...
const executionProvider: 'ant' | 'external' = 'external';
function getToolBuckets(): ToolBuckets {
  return {
    ...
    EXECUTION: {
      ...
      toolNames: new Set([BashTool.name, executionProvider === 'ant' ? TungstenTool.name : undefined].filter(n => n !== undefined))
    },
    MCP: {
      name: 'MCP tools',
      toolNames: new Set(),
