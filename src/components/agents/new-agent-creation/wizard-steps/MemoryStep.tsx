...
export function MemoryStep() {
  ...
  if ($[1] !== isUserScope) {
    t1 = isUserScope ? [{
      label: "User scope (~/.soma/agent-memory/) (Recommended)",
      value: "user"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "Project scope (.soma/agent-memory/)",
      value: "project"
    }, {
      label: "Local scope (.soma/agent-memory-local/)",
      value: "local"
    }] : [{
      label: "Project scope (.soma/agent-memory/) (Recommended)",
      value: "project"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "User scope (~/.soma/agent-memory/)",
      value: "user"
    }, {
      label: "Local scope (.soma/agent-memory-local/)",
      value: "local"
