...
export function ConfirmStep(t0) {
  ...
  if (!agent || !location) {
    return <WizardDialogLayout subtitle="Confirm and save"><Box flexDirection="column"><Text color="error">Missing agent configuration for confirmation.</Text></Box></WizardDialogLayout>;
  }
  let T0;
  let T1;
  let t10;
  ...
  if ($[4] !== agent || $[5] !== existingAgents || $[6] !== handleKeyDown || $[7] !== tools || $[8] !== location) {
    ...
    if ($[54] === Symbol.for("react.memo_cache_sentinel")) {
      t12 = <Box marginTop={1}><Text><Text bold={true}>Description</Text> (tells somacode when to use this agent):</Text></Box>;
      $[54] = t12;
    } else {
      t12 = $[54];
    }
