...
**All verifier skills are created in the project root's \`.soma/skills/\` directory.** This ensures they are automatically loaded when Claude runs in the project.

Write the skill file to \`.soma/skills/<verifier-name>/SKILL.md\`.
...
1. Where each skill was created (always in \`.soma/skills/\`)
