...
import { INSTALL_URL, PRODUCT_URL } from '../../constants/product.js';
import type { LocalJSXCommandOnDone } from '../../types/command.js';
type Platform = 'repo' | 'install';
type Props = {
  onDone: () => void;
};
...
function MobileQRCode(t0) {
  ...
  const [platform, setPlatform] = useState("repo");
  let t1;
  ...
  if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = () => {
      const generateQRCodes = async function generateQRCodes() {
        const [repo, install] = await Promise.all([qrToString(PLATFORMS.repo.url, {
          type: "utf8",
          errorCorrectionLevel: "L"
        }), qrToString(PLATFORMS.install.url, {
          type: "utf8",
          errorCorrectionLevel: "L"
        })]);
        setQrCodes({
  ...
  const t16 = platform === "repo";
  const t17 = platform === "repo";
  let t18;
  if ($[23] !== t16 || $[24] !== t17) {
    t18 = <Text bold={t16} underline={t17}>Repo</Text>;
    $[23] = t16;
    $[24] = t17;
    $[25] = t18;
  } else {
  ...
  const t20 = platform === "install";
  const t21 = platform === "install";
  let t22;
  if ($[27] !== t20 || $[28] !== t21) {
    t22 = <Text bold={t20} underline={t21}>Install</Text>;
    $[27] = t20;
    $[28] = t21;
    $[29] = t22;
  } else {
