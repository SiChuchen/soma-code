...
export function ErrorStep(t0) {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = <Box flexDirection="column" marginBottom={1}><Text bold={true}>Set Up GitHub Actions</Text></Box>;
    $[0] = t1;
  } else {
    t1 = $[0];
  }
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Box marginTop={1}><Text dimColor={true}>Manual setup is also available if you want to finish this outside the CLI.</Text></Box>;
    $[7] = t5;
  } else {
    t5 = $[7];
  }
