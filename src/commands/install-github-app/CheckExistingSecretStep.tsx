...
export function CheckExistingSecretStep(t0) {
  ...
  if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Box flexDirection="column" marginBottom={1}><Text bold={true}>Set Up GitHub Actions</Text><Text dimColor={true}>Setup API key secret</Text></Box>;
    $[15] = t8;
  } else {
    t8 = $[15];
  }
  ...
  if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Box marginBottom={1}><Text color="warning">A default API key secret already exists in repository secrets.</Text></Box>;
    $[16] = t9;
  } else {
    t9 = $[16];
  }
  ...
  if ($[28] !== cursorOffset || $[29] !== onSecretNameChange || $[30] !== onSubmit || $[31] !== secretName || $[32] !== terminalSize || $[33] !== useExistingSecret) {
    t15 = !useExistingSecret && <><Box marginBottom={1}><Text>Enter new secret name (alphanumeric with underscores):</Text></Box><TextInput value={secretName} onChange={onSecretNameChange} onSubmit={onSubmit} focus={true} placeholder="e.g., SOMA_API_KEY" columns={terminalSize.columns} cursorOffset={cursorOffset} onChangeCursorOffset={setCursorOffset} showCursor={true} /></>;
    $[28] = cursorOffset;
