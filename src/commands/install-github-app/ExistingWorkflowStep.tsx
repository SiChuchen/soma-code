...
export function ExistingWorkflowStep(t0) {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box flexDirection="column" marginBottom={1}><Text>An existing somacode workflow file already exists in <Text color="claude">.github/workflows</Text></Text><Text dimColor={true}>Legacy workflow file names are also detected here. What would you like to do?</Text></Box>;
    $[8] = t6;
  } else {
    t6 = $[8];
  }
