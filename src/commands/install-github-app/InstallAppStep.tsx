...
export function InstallAppStep(t0) {
  ...
  if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Box flexDirection="column" marginBottom={1}><Text bold={true}>Set Up GitHub Actions</Text></Box>;
    $[1] = t2;
  } else {
    t2 = $[1];
  }
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box marginBottom={1}><Text>Opening browser to the somacode setup guide…</Text></Box>;
    $[2] = t3;
  } else {
    t3 = $[2];
  }
  ...
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box marginBottom={1}><Text>If your browser doesn't open automatically, open the setup guide.</Text></Box>;
    $[3] = t4;
  } else {
    t4 = $[3];
  }
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Box marginBottom={1}><Text underline={true}>{GITHUB_ACTION_SETUP_DOCS_URL}</Text></Box>;
    $[4] = t5;
  } else {
    t5 = $[4];
  }
  let t6;
  if ($[5] !== repoUrl) {
    t6 = <Box marginBottom={1}><Text>Please continue setup for repository: <Text bold={true}>{repoUrl}</Text></Text></Box>;
    $[5] = repoUrl;
    $[6] = t6;
  } else {
    t6 = $[6];
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Box><Text bold={true} color="permission">Press Enter once you're ready to continue{figures.ellipsis}</Text></Box>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Box marginTop={1}><Text dimColor={true}>Having trouble? You can finish the setup manually with the repository guide.</Text></Box>;
    $[9] = t9;
  } else {
    t9 = $[9];
  }
