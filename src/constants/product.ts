export const PRODUCT_URL = 'https://github.com/SiChuchen/soma-code'
export const INSTALL_URL = `${PRODUCT_URL}#installation`

// somacode Remote session URLs
export const WEB_APP_BASE_URL = 'https://claude.ai'
export const WEB_APP_STAGING_BASE_URL = 'https://claude-ai.staging.ant.dev'
export const WEB_APP_LOCAL_BASE_URL = 'http://localhost:4000'
...
export function getWebAppBaseUrl(
  ...
  if (isRemoteSessionLocal(sessionId, ingressUrl)) {
    return WEB_APP_LOCAL_BASE_URL
  }
  if (isRemoteSessionStaging(sessionId, ingressUrl)) {
    return WEB_APP_STAGING_BASE_URL
  }
