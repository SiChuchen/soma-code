...
const DEFAULT_PREFIX = `You are somacode, a coding CLI assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are somacode, a coding CLI assistant running within the somacode Agent SDK.`
const AGENT_SDK_PREFIX = `You are a somacode agent, built on the somacode Agent SDK.`
