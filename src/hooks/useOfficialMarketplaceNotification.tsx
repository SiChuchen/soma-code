...
async function _temp() {
  ...
  if (result.configSaveFailed) {
    ...
    notifs.push({
      ...
      jsx: <Text color="error">Failed to save marketplace retry info · Check ~/.soma/.config.json permissions</Text>,
      priority: "immediate",
      timeoutMs: 10000
    });
  }
  if (result.installed) {
    ...
    notifs.push({
      ...
      jsx: <Text color="success">✓ somacode marketplace installed · /plugin to see available plugins</Text>,
      priority: "immediate",
      timeoutMs: 7000
    });
  } else {
    if (result.skipped && result.reason === "unknown") {
      ...
      notifs.push({
        ...
        jsx: <Text color="warning">Failed to install somacode marketplace · Will retry on next startup</Text>,
        priority: "immediate",
        timeoutMs: 8000
      });
    }
