...
async function _temp(): Promise<Notification | null> {
  ...
  if (true && !isClaudeAISubscriber()) {
    return {
      ...
      jsx: <Text color="error">somacode in Chrome requires a somacode web subscription</Text>,
      priority: "immediate",
      timeoutMs: 5000
    };
  }
  ...
  if (!installed && !isRunningOnHomespace()) {
    return {
      ...
      jsx: <Text color="warning">Chrome extension not detected · see {PRODUCT_URL} or run /chrome for setup</Text>,
      priority: "immediate",
      timeoutMs: 3000
    };
  }
  if (chromeFlag === undefined) {
    return {
      ...
      text: "somacode in Chrome enabled \xB7 /chrome",
      priority: "low"
    };
  }
  return null;
