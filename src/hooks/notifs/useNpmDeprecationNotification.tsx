...
import { isNativeInstallerAvailable } from 'src/utils/distribution.js';
import { isEnvTruthy } from 'src/utils/envUtils.js';
import { useStartupNotification } from './useStartupNotification.js';
const NPM_DEPRECATION_MESSAGE = 'somacode has switched from npm to the native installer. Run `soma install` for the recommended setup.';
...
async function _temp(): Promise<Notification | null> {
  ...
  if (installationType === "development" || installationType === "package-manager" || installationType === "unknown") {
    return null;
  }
  return {
    timeoutMs: 15000,
