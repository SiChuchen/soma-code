      ...
      switch (message.type) {
        ...
        case 'attachment':
          ...
          // Handle max turns reached signal from query.ts
            ...
            const maxTurnsAttachment = message.attachment as Extract<
              Attachment,
            ...
            yield {
              ...
              duration_api_ms: getTotalAPIDuration(),
              is_error: true,
              num_turns: maxTurnsAttachment.turnCount,
              ...
              uuid: randomUUID(),
              errors: [
                `Reached maximum number of turns (${maxTurnsAttachment.maxTurns})`,
              ],
            }
            return
          }
          // Yield queued_command attachments as SDK user message replays
            ...
            const queuedCommandAttachment = message.attachment as Extract<
              Attachment,
              { type: 'queued_command' }
            >
            yield {
              ...
              message: {
                role: 'user' as const,
                content: queuedCommandAttachment.prompt,
              },
              session_id: getSessionId(),
              parent_tool_use_id: null,
              uuid:
                queuedCommandAttachment.source_uuid ??
...
/**
 * Sends a single prompt to the somacode API and returns the response.
