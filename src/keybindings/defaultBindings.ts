...
/**
 * Default keybindings that match current somacode behavior.
...
export const DEFAULT_BINDINGS: KeybindingBlock[] = [
  ...
  },
  {
    ...
    bindings: {
      ...
      'ctrl+n': 'select:next',
      // Secondary activate key for the selected setting
      space: 'select:accept',
      // Primary Enter action in /config (toggle/change/open)
