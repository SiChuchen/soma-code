/**
 * Main entrypoint for somacode Agent SDK types.
 *
...
export type HookInputFor<EventName extends HookEvent> = Extract<
  HookInput,
...
/**
 * A scheduled task from `<dir>/.soma/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.soma/scheduled_tasks.json` and yield events as tasks fire.
 *
