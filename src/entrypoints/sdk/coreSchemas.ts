  ...
  z
    .object({
      ...
      memory: z
        ...
        .optional()
        .describe(
          "Scope for auto-loading agent memory files. 'user' - ~/.soma/agent-memory/<agentType>/, 'project' - .soma/agent-memory/<agentType>/, 'local' - .soma/agent-memory-local/<agentType>/",
        ),
      effort: z
  ...
  z
    ...
    .describe(
      'Source for loading filesystem-based settings. ' +
        "'user' - Global user settings (~/.soma/settings.json). " +
        "'project' - Project settings (.soma/settings.json). " +
        "'local' - Local settings (.soma/settings.local.json).",
    ),
)
