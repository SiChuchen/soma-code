...
export const SDKControlEndSessionRequestSchema = lazySchema(() =>
  z
    ...
    .describe('Ends the current SDK session and stops reading further input.'),
)
...
export const SDKControlChannelEnableRequestSchema = lazySchema(() =>
  z
    ...
    .describe(
      'Registers channel notifications for a marketplace-backed MCP server.',
    ),
)
...
export const SDKControlMcpOAuthCallbackUrlRequestSchema = lazySchema(() =>
  z
    ...
    .describe(
      'Submits a manual OAuth callback URL for an MCP server authentication flow.',
    ),
)
...
export const SDKControlClaudeAuthenticateRequestSchema = lazySchema(() =>
  z
    ...
    .describe('Starts an OAuth flow for the current SDK session.'),
)
...
export const SDKControlClaudeOAuthCallbackRequestSchema = lazySchema(() =>
  z
    ...
    .describe('Submits a manual authorization code for the OAuth flow.'),
)
...
export const SDKControlClaudeOAuthWaitForCompletionRequestSchema =
  lazySchema(() =>
    z
      ...
      .describe(
        'Waits for the in-flight OAuth flow to finish and returns account info.',
      ),
  )
...
export const SDKControlMcpClearAuthRequestSchema = lazySchema(() =>
  z
    ...
    .describe('Clears stored authentication state for an MCP server.'),
)
...
export const SDKControlGenerateSessionTitleRequestSchema = lazySchema(() =>
  z
    ...
    .describe('Requests a generated session title for the current conversation.'),
)
...
export const SDKControlSideQuestionRequestSchema = lazySchema(() =>
  z
    ...
    .describe(
      'Runs a side-question query against the current conversation context.',
    ),
)
