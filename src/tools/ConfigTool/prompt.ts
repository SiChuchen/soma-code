...
export const DESCRIPTION = 'Get or set somacode configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set somacode configuration settings.

  View or change somacode settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.soma/.config.json)
${globalSettings.join('\n')}
