...
function isPathAllowed(
  ...
  // and internal editable paths live under ~/.soma/ — matching the ordering in
      ...
      if (!allowed) {
        ...
        const message =
          ...
          decisionReason?.type === 'safetyCheck'
            ...
            : `${canonical} targeting '${resolvedPath}' was blocked. For security, somacode may only access files in the allowed working directories for this session: ${dirListStr}.`
