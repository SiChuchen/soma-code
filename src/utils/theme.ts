...
export type Theme = {
  ...
  // Jellyfish mascot colors
  jellyfish_body: string
  jellyfish_body_dim: string
  jellyfish_core: string
  jellyfish_core_active: string
  jellyfish_core_dim: string
  jellyfish_tentacle: string
  jellyfish_tentacle_dim: string
}
...
const lightTheme: Theme = {
  ...
  // Jellyfish mascot colors
  jellyfish_body: 'rgb(70,145,175)',
  jellyfish_body_dim: 'rgb(140,190,210)',
  jellyfish_core: 'rgb(0,140,130)',
  jellyfish_core_active: 'rgb(0,100,95)',
  jellyfish_core_dim: 'rgb(170,200,210)',
  jellyfish_tentacle: 'rgb(50,130,155)',
  jellyfish_tentacle_dim: 'rgb(120,175,195)',
}
...
const lightAnsiTheme: Theme = {
  ...
  // Jellyfish mascot colors
  jellyfish_body: 'ansi:cyan',
  jellyfish_body_dim: 'ansi:cyanBright',
  jellyfish_core: 'ansi:blue',
  jellyfish_core_active: 'ansi:blueBright',
  jellyfish_core_dim: 'ansi:blackBright',
  jellyfish_tentacle: 'ansi:cyan',
  jellyfish_tentacle_dim: 'ansi:cyanBright',
}
...
const darkAnsiTheme: Theme = {
  ...
  // Jellyfish mascot colors
  jellyfish_body: 'ansi:cyan',
  jellyfish_body_dim: 'ansi:blue',
  jellyfish_core: 'ansi:cyanBright',
  jellyfish_core_active: 'ansi:whiteBright',
  jellyfish_core_dim: 'ansi:blackBright',
  jellyfish_tentacle: 'ansi:cyan',
  jellyfish_tentacle_dim: 'ansi:blueBright',
}
...
const lightDaltonizedTheme: Theme = {
  ...
  rainbow_violet_shimmer: 'rgb(230,180,210)',
  // Jellyfish mascot colors
  jellyfish_body: 'rgb(60,140,170)',
  jellyfish_body_dim: 'rgb(130,185,205)',
  jellyfish_core: 'rgb(0,130,165)',
  jellyfish_core_active: 'rgb(0,95,130)',
  jellyfish_core_dim: 'rgb(165,195,210)',
  jellyfish_tentacle: 'rgb(45,125,155)',
  jellyfish_tentacle_dim: 'rgb(115,170,190)',
}
...
const darkTheme: Theme = {
  ...
  rainbow_violet_shimmer: 'rgb(230,180,210)',
  // Jellyfish mascot colors
  jellyfish_body: 'rgb(55,120,150)',
  jellyfish_body_dim: 'rgb(30,70,100)',
  jellyfish_core: 'rgb(0,230,210)',
  jellyfish_core_active: 'rgb(140,255,245)',
  jellyfish_core_dim: 'rgb(25,60,80)',
  jellyfish_tentacle: 'rgb(40,140,160)',
  jellyfish_tentacle_dim: 'rgb(25,90,110)',
}
...
const darkDaltonizedTheme: Theme = {
  ...
  rainbow_violet_shimmer: 'rgb(230,180,210)',
  // Jellyfish mascot colors
  jellyfish_body: 'rgb(55,130,150)',
  jellyfish_body_dim: 'rgb(30,80,105)',
  jellyfish_core: 'rgb(0,210,255)',
  jellyfish_core_active: 'rgb(160,240,255)',
  jellyfish_core_dim: 'rgb(25,65,85)',
  jellyfish_tentacle: 'rgb(40,150,175)',
  jellyfish_tentacle_dim: 'rgb(25,95,115)',
}
