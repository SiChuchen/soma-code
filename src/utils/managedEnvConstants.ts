 ...
 * overridden by a user's ~/.soma/settings.json — e.g. a Bedrock setup for
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'OPENAI_BASE_URL',
  'OPENAI_COMPAT_AUDIO_FORMAT',
  'OPENAI_COMPAT_AUDIO_VOICE',
  'OPENAI_COMPAT_API_FORMAT',
  'OPENAI_COMPAT_CUSTOM_HEADERS',
  'OPENAI_COMPAT_DISABLE_AUTH',
  'OPENAI_COMPAT_EXTRA_BODY',
  'OPENAI_COMPAT_FREQUENCY_PENALTY',
  'OPENAI_COMPAT_LOGIT_BIAS',
  'OPENAI_COMPAT_LOGPROBS',
  'OPENAI_COMPAT_MODALITIES',
  'OPENAI_COMPAT_PARALLEL_TOOL_CALLS',
  'OPENAI_COMPAT_PRESENCE_PENALTY',
  'OPENAI_COMPAT_PREDICTION_CONTENT',
  'OPENAI_COMPAT_PROFILE',
  'OPENAI_COMPAT_PROMPT_CACHE_KEY',
  'OPENAI_COMPAT_PROMPT_CACHE_RETENTION',
  'OPENAI_COMPAT_REASONING_EFFORT',
  'OPENAI_COMPAT_REASONING_SUMMARY',
  'OPENAI_COMPAT_SEED',
  'OPENAI_COMPAT_SERVICE_TIER',
  'OPENAI_COMPAT_TEMPERATURE',
  'OPENAI_COMPAT_TOP_LOGPROBS',
  'OPENAI_COMPAT_TOP_P',
  'OPENAI_COMPAT_TRUNCATION',
  'OPENAI_COMPAT_VERBOSITY',
 ...
 * These are somacode specific settings that don't pose security risks.
 *
