...
export const CLAUDE_3_7_SONNET_CONFIG = {
  ...
  openaiCompatible: 'claude-3-7-sonnet',
...
export const CLAUDE_3_5_V2_SONNET_CONFIG = {
  ...
  openaiCompatible: 'claude-3-5-sonnet',
} as const satisfies ModelConfig
...
export const CLAUDE_3_5_HAIKU_CONFIG = {
  ...
  openaiCompatible: 'claude-3-5-haiku',
} as const satisfies ModelConfig
...
export const CLAUDE_HAIKU_4_5_CONFIG = {
  ...
  openaiCompatible: 'claude-haiku-4-5',
} as const satisfies ModelConfig
...
export const CLAUDE_SONNET_4_CONFIG = {
  ...
  openaiCompatible: 'claude-sonnet-4',
} as const satisfies ModelConfig
...
export const CLAUDE_OPUS_4_CONFIG = {
  ...
  openaiCompatible: 'claude-opus-4',
} as const satisfies ModelConfig
...
export const CLAUDE_OPUS_4_1_CONFIG = {
  ...
  openaiCompatible: 'claude-opus-4-1',
} as const satisfies ModelConfig
...
export const CLAUDE_OPUS_4_5_CONFIG = {
  ...
  openaiCompatible: 'claude-opus-4-5',
} as const satisfies ModelConfig
