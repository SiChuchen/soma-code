...
/**
 * Detects if a file path is a session-related file under ~/.soma.
 ...
 * Excludes: CLAUDE.md, CLAUDE.local.md, .soma/rules/*.md (legacy .claude/rules/*.md) (user-managed).
 *
...
// Excludes CLAUDE.md, CLAUDE.local.md, .soma/rules/ and legacy .claude/rules/ (user-managed).
