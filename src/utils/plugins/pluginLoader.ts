 ...
 *
 * This module is responsible for discovering, loading, and validating somacode plugins
 ...
 * Format: ~/.soma/plugins/cache/{marketplace}/{plugin}/{version}/
 *
 * @param pluginId - Plugin identifier in format "name@marketplace"
 * @param version - Version string (semver, git SHA, etc.)
 ...
 * Format: ~/.soma/plugins/cache/{plugin-name}/
 *
