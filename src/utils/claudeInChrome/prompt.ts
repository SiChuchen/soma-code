export const BASE_CHROME_PROMPT = `# somacode in Chrome browser automation
...
/**
 * Minimal hint about somacode in Chrome skill availability. This is injected at startup when the extension is installed
