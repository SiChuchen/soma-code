...
/**
 * Renders a clickable "View Tab" link for somacode in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a somacode in Chrome MCP tool
...
/**
 * Returns tool method overrides for somacode in Chrome MCP tools. Use this to customize
...
export function getClaudeInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `somacode in Chrome[${displayName}]`;
    },
