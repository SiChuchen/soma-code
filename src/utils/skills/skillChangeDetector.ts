...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.soma/skills)
  ...
  // User commands directory (~/.soma/commands)
  ...
  // Project skills directory (.soma/skills)
  ...
  // Project commands directory (.soma/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = getProjectConfigPath(dir, 'skills')
    try {
