// Non-React scheduler core for .soma/scheduled_tasks.json.
...
type CronSchedulerOptions = {
  ...
  /**
   * Directory containing .soma/scheduled_tasks.json. When provided, the
...
export function buildMissedTaskNotification(missed: CronTask[]): string {
  ...
  const header =
    ...
    `${plural ? 'They have' : 'It has'} already been removed from .soma/scheduled_tasks.json.\n\n` +
